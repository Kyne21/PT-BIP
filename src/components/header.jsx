...
const products = [
  {
    name: "Input DO 10%",
    description: "Masukkan Data DO 10%",
    href: "/form10",
    icon: QueueListIcon,
  },
  {
    name: "Input DO 90%",
    description: "Masukkan Data DO 90%",
    href: "/form90",
    icon: QueueListIcon,
  },
  {
    name: "List DO 10%",
    description: "Lihat Data DO 10%",
    href: "/list10",
    icon: TableCellsIcon,
  },
  {
    name: "List DO 90%",
    description: "Lihat Data DO 90%",
    href: "/list90",
    icon: TableCellsIcon,
  },
];
...
export default function Header() {
  ...
  return (
    <header className="bg-white border-2 border-gray-300 shadow-sm mb-6">
      <nav
        aria-label="Global"
        className="flex max-w-8xl h-[120px] items-center justify-center p-6 lg:px-8"
      >
        <div className="flex lg:flex-1 items-center">
          <a href="/" className="flex items-center justify-center -m-1.5 p-1.5">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 hover:text-gray-700">
              Menu
              <ChevronDownIcon
                aria-hidden="true"
