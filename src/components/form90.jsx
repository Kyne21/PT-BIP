  ...
  return (
    <div className="container w-[1200px] mx-auto p-4 pt-6 md:p-6 lg:p-12 border-2 border-gray-200 rounded-2xl">
      <form onSubmit={saveData}>
        ...
        <button className='bg-[#2C2C2C] text-white hover:bg-gray-700 font-inter hover:text-white font-normal py-2 px-4 -ml-3 mt-6 rounded text-sm' variant='outlined' type="submit">Submit</button>
      </form>
    </div>
  );
};
