...
function Print() {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(input).then((canvas) => {
      ...
      const pdf = new jsPDF('p', 'mm', [120, 140], true);
  ...
  return (
    <>
    <div className="container border border-slate-800 flex flex-col mx-auto rounded-2xl"
      style={{ width: "55vw" }}>
    <div
      ref={pdfRef}
    ...
    >
      ...
      <h1 className="mx-auto text-lg font-bold font-inter">
      ...
      <div className="container font-medium">
        ...
        <div className="flex flex-nowrap my-8 justify-between">
          ...
          <p className="w-[300px] ml-20 break-words">
            ...
            Jenderal Sudirman No.53, RT.5/RW.3, Senayan, Kec. Kby. Baru, Kota
    ...
    <div class="flex justify-end mt-8 mr-72">
        <button
        onClick={downloadPDF}
          type="button"
